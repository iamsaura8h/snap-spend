...
const FloatingIllustration = () => {
  ...
  return (
    <div ref={illustrationRef} className="relative w-full max-w-3xl mx-auto">
      <img 
        src="/lovable-uploads/4dd12ac3-3343-4d41-b2d6-4e8638d2eb45.png" 
      ...
      <div className="absolute top-10 -right-8 w-12 h-12 border-2 border-gray-300 rounded-md animate-float opacity-60" style={{animationDelay: '1.5s'}}></div>
